...
def setpoint_demo():
    ...
    distLF = 0.0 # equal to time=0 distance in reality
    height = 4.0
    delay = 0.0
    wait = False

    print "Altitude Set = 4"
    setpoint.set(0.0, 0.0, 4.0, 5, True)

    #print "Fly to the right"
    #setpoint.set(3, 3, 4.0, 5, True)
    ...
    while not rospy.is_shutdown():
        ...
        print "XLocal_SP" + str(utmXRef-utmXHome-distLF)
        print "YLocal_SP" + str(utmYRef-utmYHome-distLF)
        rate.sleep()
